  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 p-6">
      <div className="w-full max-w-md overflow-hidden rounded-2xl border border-slate-200 bg-white p-8 shadow-xl shadow-slate-900/10 md:p-10">
        ...
        <h2 className="mt-3 text-2xl font-medium text-slate-900">{t('passwordReset.forgotTitle')}</h2>
        ...
        {sent ? (
          ...
          >
            ...
            <Link to="/login" className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-slate-700">
              <ArrowLeft className="h-4 w-4" />
              {t('passwordReset.backToLogin')}
            </Link>
          </form>
