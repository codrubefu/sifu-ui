  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 p-6">
      <div className="w-full max-w-md overflow-hidden rounded-2xl border border-slate-200 bg-white p-8 shadow-xl shadow-slate-900/10 md:p-10">
        <p className="text-sm font-medium normal-case tracking-normal text-indigo-600">{t('login.brand')}</p>
        <h2 className="mt-3 text-2xl font-medium text-slate-900">{t('passwordReset.setTitle')}</h2>
        ...
        {invalidLink ? (
          <div className="mt-6 space-y-6">
            ...
            <Link to="/forgot-password" className="inline-flex items-center gap-2 text-sm font-medium text-indigo-600 hover:text-indigo-700">
