  ...
  return (
    <PageShell title={t('grades.title')} subtitle={t('grades.subtitle')}>
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)]">
        <SectionCard title={t('grades.definitions')} action={canManage ? <button onClick={startCreateGrade} className="rounded-lg bg-indigo-600 px-3 py-2 text-sm font-semibold text-white"><Plus className="mr-2 inline h-4 w-4" />{t('grades.add')}</button> : null}>
